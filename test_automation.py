...
def _switch_to_standard_sinhala(page):
    try:
        page.wait_for_timeout(1000)

        selectors = [
            "text=Standard Sinhala",
            "button:has-text('Standard Sinhala')",
        ]
        ...
        for sel in selectors:
            try:
                ...
                if btn.is_visible():
                    ...
                    print("✅ Switched to Standard Sinhala mode")
                    return
            except:
                continue

        print("⚠️ Could not switch to Standard Sinhala")
